...
public class ProductActivity extends AppCompatActivity {
    static final String uri ="content://com.example.app_provider";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_Save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Uri inser6t_uri = getContentResolver().insert(product, values);
        ...
        btn_Select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Uri product = Uri.parse(uri);
                Cursor cursor = getContentResolver().query(product, null, null,null,"name");//sap xep theo name
                if(cursor != null){
                    cursor.moveToFirst();
                    do{
