    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Nếu et_Id rỗng --> getAllAuthor, ngược lại getAuthor
...
//                        listString.add("Mã này không tồn tại author");
        ...
        gridViewAuthors.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                ed_id.setEnabled(false);//khong hien ma
            }
        });
        ...
        bt_Thoat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(AuthorActivity.this);//MainActivity.this
